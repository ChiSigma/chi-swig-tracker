...
class DrinkerForm extends React.Component {
  state = { ...this.props.drinker, changed: false };
    ...
    return (
      <form className={classes.container} 
        ...
        <TextField
          ...
          label="Profile Photo"
          className={classes.textField}
          value={this.state.profile_photos}
          onChange={this.handleChange('profile_photos')}
          onClick={ (e) => { e.stopPropagation() } }
          margin="normal"
        />
        <TextField
...
DrinkerForm.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(DrinkerForm);
